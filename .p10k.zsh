# Generated by Powerlevel10k configuration wizard on 2026-09-17 at 22:01 PDT.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_LUAENV_VISUAL_IDENTIFIER_EXPANSION='󰢱'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_WIFI_VISUAL_IDENTIFIER_EXPANSION='󰖩'
